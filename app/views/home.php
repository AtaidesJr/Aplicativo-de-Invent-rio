...
<body>
    ...
    <main>
        ...
        <div class="container">
            ...
            <h1 class="font_inria" style="text-align: center;">Itens por Formulário</h1>
                ...
                <div class="font_inria" style="height: 100%; min-height: 100px; width: 100%; max-width: 400px; display: none; overflow-wrap: break-word;">
                    <div class="resultado">
                        <span class="justify-center items-center" id="result">
                            <form id="form_inventario" action="/inventario/adicionar" method="POST">
                                <label class="text-center">Código do Item</label>
                                <input class="form-control text-center" type="text" id="cod_item" name="cod_item" readonly>
                                <label class="text-center">Descrição </label>
                                <input class="form-control text-center" type="text" id="descricao_item" name="descricao_item" readonly>
                                <label class="text-center">Unidade de Medida </label>
                                <input class="form-control text-center" type="text" id="unidade_item" name="unidade_item" readonly>
                                <label class="text-center">Depósito </label>
                                <input class="form-control text-center" type="text" id="deposito_item" name="deposito_item" readonly>
                                <label class="text-center">Número do Formulario</label>
                                ...
                                <input class="form-control text-center" type="number" id="quantidade_item" name="quantidade_item" step="0.01" required>
    ...
    <footer class="hidden-print">
        <div class="modal-footer" style="justify-content: center;">
            ...
            <?php endif ?>
            <a href="/caixa_agrupamento"><button class="btn btn-sm btn-secondary">Leitor por Caixas</button></a>
