...
<body id="retorno" style="background-color: #f2f2f2;">
    ...
    <div class="zoom_90">
        ...
        <div class="container-fluid p-3 position-absolute">
            ...
            <br>
            <h5 class="text-center fw-bold">Relatório de Conferência por Caixas Agrupadas</h5>

            <div class="mb-12 mb-md-12">
                <form id="formBusca" action="/visualizacao_caixa_agrupada" method="POST">
                    <div class="row">
                        ...
                        <tbody class="thead-light">
                            <?php foreach ($resultados as $resultado) : ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $resultado['Deposito'] ?></td>
                                    <td><?php echo $resultado['Secao'] ?></td>
                                    <td><?php echo $resultado['Caixa'] ?></td>
                                    <td><?php echo $resultado['Formulario'] ?></td>
