...
function run() {
    ...
    function displayText(text) {
        if (text.slice(0, 4) == 'http') {
            ...
            document.getElementById('cod_item').value = parts[0];
            document.getElementById('descricao_item').value = parts[1];
            document.getElementById('unidade_item').value = parts[2];
            document.getElementById('deposito_item').value = parts[3];
            document.getElementById('num_formulario').value = parts[4];
            // document.getElementById('quantidade').value = parts[5];
